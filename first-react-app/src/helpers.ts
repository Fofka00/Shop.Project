import { IComment, IProductImage, CommentCreatePayload } from "../Shared/types";
import {
...
import { mapCommentEntity } from "../Server/services/mapping";
import { mapImageEntity } from "../Server/services/mapping";
...
const requiredFields = new Set(["name", "email", "body", "productId"]);
